		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-6 col-lg-12">
					<img src="image/viewcust.jpg" alt="Picture" class="img-responsive" style="width:100%;height:490px;margin-top:20px;" />
				</div>
				<div class="col-lg-6 col-lg-12">
					<div class="table-responsive">
						<div class="box">
							<div class="box-header">
								<h3 class="box-title">View Registered Users</h3>
							</div>
							<div class="box-body">
								<table id="example2" class="table table-bordered table-striped">
									...
									?>
										<tr>
											...
											<td><a href="customer_delete.php?id=<?php echo $d['id'];?>" onClick="return confirm('Are Sure You Want to Delete The User ?')"><img src="image/delete.svg" alt="" style="height:30px;" /></a></td>
										</tr>
										<?php } ?>
									</tbody>
								</table>
